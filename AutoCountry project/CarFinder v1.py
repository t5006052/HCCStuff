#READ THIS FIRST
#it is crucial tht AVLv1.txt is in the SAME FOLDER as this file or else it will throw a cannot find file error
#thank you!

#I cannot imagine a world where anyone could of programmed this without using a function this whole time, that would of been the worlds largest headache
import os
avl = []
rep = True
